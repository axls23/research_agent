...
class ResearchExtractor:
    ...
    def extract_topics_and_goals(self, query: str, limit: int = 5) -> Dict[str, Any]:
        ...
        return {"topics": list(topics), "goals": list(goals)}
    ...
    def _clean_text(self, text: str) -> str:
        ...
        text = text.strip()
        text = re.sub(
            r"^(The|This|Our|We|In this|Here|To|For)", "", text, flags=re.IGNORECASE
        )
...
def build_word2vec_model(
    chunks: List[Dict[str, Any]], vector_size: int = 100
) -> Word2Vec:
...
def create_qdrant_points(
    chunks: List[Dict[str, Any]], word2vec_model: Word2Vec
